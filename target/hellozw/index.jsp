...
<head>
    ...
    <style>
        body {
            ...
            background-image: url("https://ss1.bdstatic.com/kvoZeXSm1A5BphGlnYG/skin/400.jpg?2");
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
...
<div class="row myrow">
    <div class="col-md-6">
        <h2 class="featurette-heading">个性导航</h2>
...
<div class="row myrow">
    ...
    <div class="col-md-6">
        <h2 class="featurette-heading">同学汇</h2>
...
<div class="row myrow">
    <div class="col-md-6">
        <h2 class="featurette-heading">我的博客</h2>
...
<div class="row myrow">
    ...
    <div class="col-md-6">
        <h2 class="featurette-heading">明星1+1</h2>
